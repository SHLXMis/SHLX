...
namespace Redsoft
{
    public partial class d_cxn_q412_b_updt : UserControl, IGrid
    {
        public d_cxn_q412_b_updt()
        {
            InitializeComponent();
        ...
        public IList<Column> GetCols()
        {
            IList<Column> cols = new List<Column>();
             ...
             cols.Add(new Column("2","sy_id","ID号",false,98,634,"1","long",true,"","[general]",false,"","","",EditType.Edit,"1"));
             ...
             cols.Add(new Column("6","dd","常温磁矩",true,83,445,"0","number",false,"","[general]",false,"","","",EditType.Edit,"1"));
             cols.Add(new Column("7","ee","高温磁矩",true,100,531,"0","number",false,"","[general]",false,"","","",EditType.Edit,"1"));
