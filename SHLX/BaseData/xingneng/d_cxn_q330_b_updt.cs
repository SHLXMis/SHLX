...
namespace Redsoft
{
    public partial class d_cxn_q330_b_updt : UserControl, IGrid
    {
        public d_cxn_q330_b_updt()
        {
            InitializeComponent();
        ...
        public IList<Column> GetCols()
        {
            IList<Column> cols = new List<Column>();
             ...
             cols.Add(new Column("3","aa","磁通",true,96,2,"1","number",false,"","[general]",false,"","","",EditType.Edit,"1"));
             cols.Add(new Column("4","bb","客户磁通",true,118,404,"0","number",false,"","[general]",false,"","","",EditType.Edit,"1"));
             cols.Add(new Column("5","cc","磁矩",true,132,525,"0","number",false,"","[general]",false,"","","",EditType.Edit,"1"));
             cols.Add(new Column("6","dd","Dd",false,114,660,"0","number",false,"","[general]",false,"","","",EditType.Edit,"1"));
        ...
        public string Sql
        {
            get { return "  SELECT cxn_b.xh,cxn_b.sy_id,cxn_b.aa,cxn_b.bb,cxn_b.cc,cxn_b.dd,cxn_b.xgsj      FROM cxn_b     WHERE cxn_b.sy_id = :sy_id   ORDER BY cxn_b.xh ASC   "; }
        }
