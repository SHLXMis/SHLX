...
namespace Redsoft
{
    public partial class d_cxn_q180_b_updt : UserControl, IGrid
    {
        public d_cxn_q180_b_updt()
        {
            InitializeComponent();
        ...
        public IList<Column> GetCols()
        {
            IList<Column> cols = new List<Column>();
             ...
             cols.Add(new Column("3","aa","N极表场",true,67,2,"1","number",false,"","[general]",false,"","","",EditType.Edit,"1"));
             cols.Add(new Column("4","bb","S极表场",true,75,72,"1","number",false,"","[general]",false,"","","",EditType.Edit,"1"));
             cols.Add(new Column("5","cc","N/S表场差%",true,90,149,"0","number",false,"","[general]",false,"","","",EditType.Edit,"1"));
             cols.Add(new Column("6","dd","Dd",false,100,546,"0","number",false,"","[general]",false,"","","",EditType.Edit,"0"));
             cols.Add(new Column("7","xgsj","修改时间",true,149,293,"0","datetime",false,"","[shortdate] [time]",false,"","","",EditType.Edit,"1"));
