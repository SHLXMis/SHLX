...
namespace Redsoft
{
    public partial class d_cxn_print_h_list : UserControl, IGrid
    {
        public d_cxn_print_h_list()
        {
            InitializeComponent();
